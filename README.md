...
- **Tre numeri sempre visibili in home**: saldo iniziale, saldo attuale stimato (saldo iniziale − spese del ciclo) e quanto hai risparmiato finora (saldo iniziale − spese − budget non ancora usato nelle altre categorie).
...
- **7 categorie con budget mensile**: Bar e Cene/Pranzi (250 €, con sotto-voci Bar/Cene-Pranzi e progresso settimanale), Bellezza (100 €, con sotto-voci Trucchi/Vestiti/Skincare/Capelli), Affitto (390 €), Bollette (40 €), Spesa (130 €), Dentista (86 €), Benzina (250 €).
- **Barre di avanzamento pastello per categoria**, con importo, percentuale e avviso quando ci si avvicina o si supera il budget.
- **Riepilogo settimanale per Bar e Cene/Pranzi**: quanto speso questa settimana e se sei in linea o sopra il ritmo necessario per rispettare il budget mensile.
